      ...
      <section className="rw-container pb-10 pt-16 md:pt-20">
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-[0.92fr_1.08fr]">
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-[36px] border border-transparent bg-[rgba(88,54,49,0.56)] shadow-[0_24px_70px_rgba(0,0,0,0.18)] backdrop-blur-2xl">
              <div className="relative min-h-[500px] p-4 md:p-6">
                ...
                <div className="relative z-10 mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {[
                    ...
                    >
                      <div className="absolute right-4 top-4 rounded-full border border-transparent px-3 py-1 text-center text-[11px] leading-none text-[#ffb1aa]">
